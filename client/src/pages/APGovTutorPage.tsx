...
import { Send, Sparkles, GraduationCap, Bot, History, ChevronLeft, Building2 } from "lucide-react";
...
export default function APGovTutorPage() {
  const [inputValue, setInputValue] = useState("");
  const chatContainerRef = useRef<HTMLDivElement>(null);
  const { messages, sendMessage, isLoading } = useChat("APGOV");
  const { isPasswordProtected, showPasswordDialog, setShowPasswordDialog, validatePassword } = usePasswordProtection("APGOV_PASSWORD");
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold mb-4">
            <span className="text-primary glow-primary">AP Government and Politics</span> AI Tutor
          </h1>

          <p className="text-neutral-400 max-w-3xl mx-auto">
            Ask questions about any AP Government and Politics topic and get accurate, contextual answers based on the official College Board Course and Exam Description.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="border border-neutral-200/20 shadow-xl shadow-primary/5 bg-neutral-100/20 backdrop-blur-sm overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-primary/80 to-primary text-white p-4 flex items-center">
              ...
              <div>
                <h3 className="font-bold">AP Government AI Tutor</h3>
            ...
            <div className="border-t border-neutral-200/20 p-4 bg-neutral-100/50">
              <form onSubmit={handleSubmit} className="flex">
                <Input
                  ...
                  placeholder="Ask a question about Government and Politics..."
                  disabled={isLoading}
                />
                <Button
                  type="submit"
